...
| `⧉` | `worktree.state` `"duplicate_branch"` | Branch checked out in more than one worktree; `wt` resolves it to whichever git lists first, and every affected row is flagged |
