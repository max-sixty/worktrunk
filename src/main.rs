...
use commands::{
    ...
    handle_list, handle_logs_list, handle_logs_profile, handle_merge, handle_omp_install,
    handle_omp_uninstall, handle_opencode_install, handle_opencode_uninstall, handle_pi_install,
    handle_pi_uninstall, handle_promote, handle_rebase, handle_remove_command, handle_show_theme,
