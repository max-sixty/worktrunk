...
use commands::{
    ...
    handle_logs_get, handle_show_theme, handle_squash, handle_state_clear, handle_state_clear_all,
    handle_state_get, handle_state_set, handle_state_show, handle_unconfigure_shell, plan_switch,
        ...
        Commands::Config { action } => match action {
            ...
            ConfigCommand::State { action } => match action {
                ...
                StateCommand::Logs { action } => match action {
                    Some(LogsAction::Get { hook, worktree }) => {
                        handle_logs_get(hook, worktree)
                    }
