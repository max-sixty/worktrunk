...
//! | `has-added-changes/` | `git::repository::sha_cache` | `plumbing-{branch_sha}-{target_sha}.json` | Never — content-addressed |
//! | `diff-stats/` | `git::repository::sha_cache` | `plumbing-{base_sha}-{head_sha}.json` | Never — content-addressed |
