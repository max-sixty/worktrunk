...
mod tests {
    ...
    fn test_warn_unknown_keys_suggests_other_config() {
        ...
        assert_snapshot!(
            ...
            @"[33m▲[39m [33mKey [1mskip-shell-integration-prompt[22m belongs in user config (will be ignored); to scope it to this repo, add it under [projects.\"<id>\"] in user config[39m");
