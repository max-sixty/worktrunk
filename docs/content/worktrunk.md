...
Work on your changes. Check all worktrees with [`wt list`](@/list.md):
...
The `-x` flag runs a command after switching. Configure [post-start hooks](@/hook.md) to automate setup.
