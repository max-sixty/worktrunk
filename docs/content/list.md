...
| Summary | LLM-generated branch summary; requires `--full` or `summary = true` in `[list.columns]`, plus `[list] summary = true` and [`commit.generation`](@/config.md#commit) <span class="badge-experimental"></span> |
