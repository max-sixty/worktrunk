...
curl -fsSL "$insta_url" -o "$tools_tmp/$insta_archive"
...
curl -fsSL "$nextest_url" -o "$tools_tmp/$nextest_archive"
...
curl -fsSL "$nu_url" -o "$tools_tmp/$nu_archive"
...
curl -fsSL "$pwsh_url" -o "$tools_tmp/$pwsh_archive"
