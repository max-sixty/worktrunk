...
//! ## Windows support
//!
//! Mock commands work on Windows via mock-stub.exe, a helper binary that
//! delegates to bash with a companion shell script. This allows Rust's
//! `Command::new("gh")` to find mock commands (CreateProcessW only searches
//! for `.exe` files).
