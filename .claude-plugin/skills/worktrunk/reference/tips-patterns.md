...
See [Designing effective hooks](https://worktrunk.dev/hook/#designing-effective-hooks) for cross-platform CoW commands, language-specific tips, and more patterns.
