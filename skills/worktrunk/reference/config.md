...
[Hooks](https://worktrunk.dev/hook/) use the same three forms as elsewhere — a string is one command, a table runs commands concurrently, a `[[...]]` array is a pipeline of steps. Each form is keyed under `projects."..."`:
